...
import { login as apiLogin } from "../../server";
import ReconLoader from "../pages/ReconLoader"; // Import the loader component
import "./ReconLoader.css"; // Import the CSS file
...
export default function SignIn() {
  ...
  return (
    <>
      {/* Full Screen Recon Loader */}
      {isLoading && <ReconLoader />}
