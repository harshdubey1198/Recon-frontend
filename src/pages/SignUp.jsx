...
export default function SignUp() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Fake registration: replace with API call later
    await new Promise((resolve) => setTimeout(resolve, 1000));
    console.log("REGISTER (fake):", { email });
    setIsLoading(false);
    navigate("/signin");
  };
      ...
      <div className="w-full max-w-5xl flex bg-white rounded-3xl shadow-xl overflow-hidden">
        ...
        <div className="flex-1 p-12 lg:p-16">
          ...
          <div className="mb-10">
            ...
            <p className="text-gray-600">Sign up to get started with Recon</p>
          </div>
          ...
          <div className="relative z-10 flex flex-col justify-center items-center p-12 text-white text-center">
            <div className="mb-8">
              ...
              <p className="text-gray-300 leading-relaxed">
                Create an account and start sharing news across multiple domains.
              </p>
            </div>
