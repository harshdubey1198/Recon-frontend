...
export default function PortalLeaderboard() {
  ...
  return (
    <>
      ...
      <div className="bg-gray-100 rounded-2xl border border-purple-100 p-2 mb-8">
          ...
          <div className="bg-white rounded-3xl shadow-2xl max-w-7xl w-full max-h-[100vh] overflow-hidden animate-in fade-in duration-300">
            ...
            <div className="bg-black p-6 relative">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h2 className="text-3xl font-bold text-white">{portalDetailData.name}</h2>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                  ...
                  <p className="text-3xl font-bold text-white mt-1">{portalDetailData.success}</p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                  <p className="text-blue-100 text-sm">Success Rate</p>
                  <p className="text-3xl font-bold text-white mt-1">{portalDetailData.publishedPercent}%</p>
                </div>
                {/* <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                  <p className="text-blue-100 text-sm">Total Distributions</p>
                  <p className="text-3xl font-bold text-white mt-1">{portalDetailData.total}</p>
                </div> */}
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4">
