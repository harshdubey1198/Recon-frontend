...
import { Upload, X, Crop, ImageIcon, AlertCircle } from "lucide-react";

const FeaturedImageSection = ({ imagePreview, setShowCropper, removeImage, handleImageUpload }) => {
  return (
    <section className="space-y-5">
      ...
      {imagePreview ? (
        ...
        <label htmlFor="image-upload" className="border-dashed border-gray-300 rounded-xl p-12 text-center cursor-pointer transition-all group">
          <div className="flex flex-col items-center">
            <div className="p-4 bg-gray-100 rounded-full group-hover:bg-gray-200 transition-all">
              <Upload className="w-8 h-8 text-gray-600" />
            </div>
            <p className="text-base font-medium mt-4 text-gray-700">Click to upload image</p>
